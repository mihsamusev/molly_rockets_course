...
0000000000001149 <main>:
    ...
    1155:	c7 45 ec 00 00 00 00 	mov    DWORD PTR [rbp-0x14],0x0
    115c:	48 c7 45 f8 00 04 00 	mov    QWORD PTR [rbp-0x8],0x400
    1163:	00 
    1164:	48 c7 45 f0 00 00 00 	mov    QWORD PTR [rbp-0x10],0x0
    116b:	00 
    116c:	eb 13                	jmp    1181 <main+0x38>
    116e:	48 8b 45 f0          	mov    rax,QWORD PTR [rbp-0x10]
    1172:	89 c2                	mov    edx,eax
    1174:	8b 45 ec             	mov    eax,DWORD PTR [rbp-0x14]
    1177:	01 d0                	add    eax,edx
    1179:	89 45 ec             	mov    DWORD PTR [rbp-0x14],eax
    117c:	48 83 45 f0 01       	add    QWORD PTR [rbp-0x10],0x1
    1181:	48 8b 45 f0          	mov    rax,QWORD PTR [rbp-0x10]
    1185:	48 3b 45 f8          	cmp    rax,QWORD PTR [rbp-0x8]
    1189:	72 e3                	jb     116e <main+0x25>
    118b:	8b 45 ec             	mov    eax,DWORD PTR [rbp-0x14]
